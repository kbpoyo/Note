...
更多关于 Spring 参数校验请参考：[Spring Validation最佳实践及其实现原理，参数校验没那么简单！open in new window](https://juejin.cn/post/6856541106626363399)
...
>原文链接：[Controller就该这么写](https://gelald.github.io/javrin/writings/Spring/pretty-controller.html)
